...
public static partial class ResultOptionExtensions
{
    ...
    /// </list>
    /// </summary>
    public static Result<T> ToResult<T>(this Result<Option<T>> resultOption, string errorMessage) =>
        resultOption.IsSuccess
            ? resultOption.Value.Value.ToResult(errorMessage)
    ...
    /// </list>
    /// </summary>
    public static Result<T> ToResult<T>(this Result<Option<T>> resultOption, IResultError error) =>
        resultOption.IsSuccess
    ...
    /// </list>
    /// </summary>
    public static async Task<Result<T>> ToResultAsync<T>(this Task<Result<Option<T>>> resultOptionTask, string errorMessage)
    {
    ...
    /// </list>
    /// </summary>
    public static async Task<Result<T>> ToResultAsync<T>(this Task<Result<Option<T>>> resultOptionTask, IResultError error)
    {
        var resultOption = await resultOptionTask;
