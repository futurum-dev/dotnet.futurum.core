...
public readonly partial struct Result
{
    ...
    /// </summary>
    public Result EnhanceWithError(string errorMessage)
    {
...
public readonly partial struct Result<T>
{
    ...
    /// </summary>
    public Result<T> EnhanceWithError(string errorMessage)
    {
...
public static partial class ResultExtensions
{
    ...
    /// </summary>
    public static async Task<Result> EnhanceWithErrorAsync(this Task<Result> resultTask, string errorMessage)
    {
    ...
    /// If async <see cref="Result"/> <see cref="Result.IsFailure"/> is true, then add additional error context
    /// </summary>
    public static async Task<Result> EnhanceWithErrorAsync(this Task<Result> resultTask, IResultErrorNonComposite error)
    {
        var result = await resultTask;
    ...
    /// </summary>
    public static async Task<Result<T>> EnhanceWithErrorAsync<T>(this Task<Result<T>> resultTask, string errorMessage)
    {
        var result = await resultTask;
    ...
    /// If async <see cref="Result{T}"/> <see cref="Result{T}.IsFailure"/> is true, then add additional error context
    /// </summary>
    public static async Task<Result<T>> EnhanceWithErrorAsync<T>(this Task<Result<T>> resultTask, IResultErrorNonComposite error)
    {
        var result = await resultTask;
