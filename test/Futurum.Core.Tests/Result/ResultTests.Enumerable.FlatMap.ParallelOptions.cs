...
public class ResultEnumerableFlatMapParallelOptionsTests
{
    ...
    public class NonGenericReturn
    {
        ...
        public async Task AllFailure()
        {
            ...
            var outputResult = await input.FlatMapAsync(new ParallelOptions { MaxDegreeOfParallelism = 2 },
                                                        x =>
                                                        {
    ...
    public class IEnumerableToResultIEnumerableToResultIEnumberable
    {
        ...
        public async Task AllSuccess()
        {
            ...
            var outputResult = await input.FlatMapAsync(new ParallelOptions { MaxDegreeOfParallelism = 2 },
                                                        x => TransformToArray(x).ToResultOkAsync());
    ...
    public class IEnumerableToResultListToResultIEnumberable
    {
        ...
        public async Task AllFailure()
        {
            ...
            var outputResult = await input.FlatMapAsync(new ParallelOptions { MaxDegreeOfParallelism = 2 },
                                                        x =>
                                                        {
                                                            if (x == 1) return Core.Result.Result.FailAsync<List<int>>(ErrorMessage1);
