...
public class ResultCompensateWhenAnyNonCompositeResultErrorTests
{
                    ...
                    public class WhenIResultErrorTypeMatches
                    {
                        public class WhenFilterFuncTrue
                        {
                            ...
                            public void FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = resultInput.CompensateWhenAny<ResultErrorTest>(error => error.ErrorMessage == ErrorMessage1,
                                                                                                  error =>
                                                                                                  {
                                                                                                      passedError = error;
                        ...
                        public class WhenFilterFuncFalse
                        {
                            ...
                            public void FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = resultInput.CompensateWhenAny<ResultErrorTest>(error => error.ErrorMessage == ErrorMessage2,
                                                                                                  error =>
                                                                                                  {
                                                                                                      passedError = error;
                    ...
                    public class WhenIResultErrorTypeMatches
                    {
                        public class WhenFilterFuncTrue
                        {
                            ...
                            public async Task FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = await resultInput.CompensateWhenAnyAsync<ResultErrorTest>(error => error.ErrorMessage == ErrorMessage1,
                                                                                                             error =>
                                                                                                             {
                                                                                                                 passedError = error;
                        ...
                        public class WhenFilterFuncFalse
                        {
                            ...
                            public async Task FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = await resultInput.CompensateWhenAnyAsync<ResultErrorTest>(error => error.ErrorMessage == ErrorMessage2,
                                                                                                             error =>
                                                                                                             {
                                                                                                                 passedError = error;
                    ...
                    public class WhenIResultErrorTypeMatches
                    {
                        public class WhenFilterFuncTrue
                        {
                            ...
                            public async Task FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = await resultInput.CompensateWhenAnyAsync<string, ResultErrorTest>(error => error.ErrorMessage == ErrorMessage1,
                                                                                                                     error =>
                                                                                                                     {
                                                                                                                         passedError = error;
                        ...
                        public class WhenFilterFuncFalse
                        {
                            ...
                            public async Task FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = await resultInput.CompensateWhenAnyAsync<string, ResultErrorTest>(error => error.ErrorMessage == ErrorMessage2,
                                                                                                                     error =>
                                                                                                                     {
                                                                                                                         passedError = error;
                            ...
                            public async Task FailureInput_FailureOutput()
                            {
                                ...
                                var resultOutput = await resultInput.CompensateWhenAnyAsync<string, ResultErrorTest>(error => error.ErrorMessage == ErrorMessage1,
                                                                                                                     error =>
                                                                                                                     {
                                                                                                                         ...
                                                                                                                         return Core.Result.Result.FailAsync<string>(
